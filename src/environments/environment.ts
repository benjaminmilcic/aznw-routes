...
export const environment = {
  ...
  triviaQuiz: {
    ...
    questionsByNumbersApi: `http://${ip}:3000/trivia/questions/by-numbers`,
  },
  error: {
  ...
  imagegen: {
    apiUrl: `http://${ip}:3000/imagegen`,
  },
  search: {
    embedUrl: `http://${ip}:3000/imagegen/embed`,
  },
  production: false,
