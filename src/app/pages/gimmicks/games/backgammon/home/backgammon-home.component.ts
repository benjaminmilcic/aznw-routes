...
import { AVATARS, BackgammonService } from '../game/backgammon.service';
import type { BgLevel, BgMode } from '../game/game.types';

/** Startbildschirm: Spielart wählen, Name/Zeichen festlegen, Spiel starten. */
@Component({
  selector: 'app-backgammon-home',
  imports: [CommonModule, FormsModule, TranslateModule, IonSegment, IonSegmentButton, IonLabel],
  templateUrl: './backgammon-home.component.html',
  styleUrl: './backgammon-home.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BackgammonHomeComponent implements OnInit {
  protected readonly svc = inject(BackgammonService);

  protected readonly avatars = AVATARS;

  protected readonly mode = signal<BgMode>('computer');
  protected readonly level = signal<BgLevel>('medium');
  ...
  protected onMode(value: BgMode): void {
    this.mode.set(value);
