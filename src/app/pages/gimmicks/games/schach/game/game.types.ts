...
// white = Gastgeber (Host), Figuren unten; black = Gast / Computer, Figuren oben.
export type ChessColor = 'white' | 'black';

/** Spielart: gegen den Computer oder online gegen einen echten Mitspieler. */
export type ChessMode = 'computer' | 'online';

/** Spielstärke des Computers. */
export type ChessLevel = 'easy' | 'medium' | 'hard';
...
/** Kompakte Stellung für die Zugsuche (ohne Spieler-Metadaten). */
