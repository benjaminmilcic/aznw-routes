...
import { AVATARS, MillService } from '../game/mill.service';
import type { MillLevel, MillMode } from '../game/game.types';
...
@Component({
  ...
  templateUrl: './mill-home.component.html',
  styleUrl: './mill-home.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MillHomeComponent implements OnInit {
  protected readonly svc = inject(MillService);

  protected readonly avatars = AVATARS;

  protected readonly mode = signal<MillMode>('computer');
  protected readonly level = signal<MillLevel>('medium');
  ...
  protected onMode(value: MillMode): void {
    this.mode.set(value);
