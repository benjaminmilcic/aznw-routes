...
/**
 * Avatar für den Computer-Gegner. Bewusst NICHT Teil von CARD_MOTIFS,
 * damit er nie als Spielkarte auftaucht.
 */
export const ROBOT_MOTIF: CardMotif = {
  id: 'robot',
  name: 'Computer',
  svg: `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <line x1="50" y1="10" x2="50" y2="22" stroke="#7a8794" stroke-width="4" stroke-linecap="round"/>
      <circle cx="50" cy="10" r="6" fill="#f6c945"/>
      <rect x="20" y="22" width="60" height="48" rx="14" fill="#9aa7b4"/>
      <rect x="28" y="32" width="44" height="24" rx="10" fill="#16318b"/>
      <circle cx="40" cy="44" r="6" fill="#7ad0ff"/>
      <circle cx="60" cy="44" r="6" fill="#7ad0ff"/>
      <rect x="40" y="60" width="20" height="4" rx="2" fill="#5c6975"/>
      <rect x="10" y="38" width="8" height="18" rx="4" fill="#7a8794"/>
      <rect x="82" y="38" width="8" height="18" rx="4" fill="#7a8794"/>
      <rect x="32" y="72" width="36" height="14" rx="6" fill="#7a8794"/>
    </svg>`,
};

/** Alle Motive inklusive Avatare – für die Anzeige (nicht für die Karten). */
export const ALL_MOTIFS: CardMotif[] = [...CARD_MOTIFS, ROBOT_MOTIF];
