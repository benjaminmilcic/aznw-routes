...
@Component({
  selector: 'app-location-map-old',
  imports: [CommonModule, FormsModule, TranslateModule],
  templateUrl: './location-map-old.component.html',
  styleUrl: './location-map-old.component.css',
})
export class LocationMapOldComponent implements AfterViewInit, OnDestroy {
  @Input() lat: number;
  @Input() lng: number;
